  ...
  return (
    <section
      className={joinClassNames(
        "glass-panel-leave rounded-[28px] border border-slate-200 bg-white p-6 shadow-sm",
        className,
      )}
    >
      <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
        <div>
          <div className="inline-flex rounded-full border border-orange-200/80 bg-orange-100/75 px-3 py-1 text-xs font-medium tracking-[0.2em] text-orange-600">
            Create
          </div>
